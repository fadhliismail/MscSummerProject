...
import com.fadhliismail.physicalweb.PwoMetadata.BleMetadata;
import com.fadhliismail.physicalweb.PwoMetadata.UrlMetadata;
...
public class NearbyBeaconsFragment extends ListFragment
  ...
  public void onListItemClick(ListView l, View v, int position, long id) {
    ...
    intent.setClass(getActivity(), HueLamp.class);
  ...
  public void onPwoDiscovered(PwoMetadata pwoMetadata) {
    // only show beacon with Lamp in url
    if(pwoMetadata.url.contains("Lamp")){
